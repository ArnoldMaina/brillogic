	 <div class="header-top"style="background-color:black;>
		 <!--container-->
		  <div class="container">
			 <div class="top-nav">
						<div class="logo">
						<a href="#"><img src="images/logo.jpeg" id="section-1" class="img-responsive" alt=""/></a>
						</div>
						<div class="menu">
						<ul id="nav">
                        ...
                        <li><a href="category.php" onclick="javascript:window.open('subcat.php?catid=27','_self')">Category</a></li>

							 <li><a href="index.php#section-4"   onclick="javascript:window.open('index.php#section-4','_self')">                           Portfolio</a></li>

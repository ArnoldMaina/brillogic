	  ...
	  <span></span><img src="images/about-img.png" alt=""><span></span>
	   ...
	   <div class="container">
		 <div class="col-md-4 about-grids">
			 <h4 style="color:#000"><span class="icon1"></span>Our Aim</h4>
			 <p style="color:#000">NOT TO BE THE BIGGEST BUT THE BEST</p>
		 </div>
		 <div class="col-md-4 about-grids grid2">
			 <h4 style="color:#000"><span class="icon2"></span>Our Mission</h4>
			 <p style="color:#000"> Customer satisfaction in utilising techonogly to expand their brand/business. To continue to consistently and successfully deliver Technology Solutions.</p>
...
<div id="portfolio" class="portfolio">
   <div class="top-tours-head text-center">
		  <h3>Gallery</h3>
		  <h1> IMPROVE YOUR WEBSITE TRAFFIC WITH THE LATEST SEO TOOLS</h1>
...
<div class="tour-guides section" id="section-4" >
	  <div class="tour-guides-head text-center">
		  ...
		  <div class="container">
				<p style="color:#000">First we get an idea of from you so as to make a product that will make our clients happy. Once we have an idea of what you want, our software engineers will refine your ideas to help with your vision.
...
while($data=mysqli_fetch_array($result))
{
	...
	{
	?>
	<a href="https://www.etrrepairs.co.ke">Company site</a>
         <a href="https://www.metrepairs.co.ke">Event and ticket booking site</a>
...
<div id="section-5" class="contact section">
	  <div class="contact-head text-center">
          ...
          <h4 style="color:#000">Want a website/application for your business and optimise your website with the latest seo tools
		  ...
		  <div class="contact-grids">
			  <div class="container">
				  <div class="col-md-4 address">
						...
						<h5 style="color:#000"><span class="img3"></span>NASRA GARDENS, GATE A near MAMA Lucy Kibaki hospital</h5>
                        <br/>
